	...
	return (
		<>
			<div className="grid grid-cols-2 gap-[2rem] md:grid-cols-3 lg:grid-cols-4">
				<NftCard isLoading={isLoading} loadingMessage={"Loading Owned Nfts"} balance={ownedNfts as BalanceItem[]} handleNftButtonText="Sell" onHandleButtonClick={sellNft} address={nftContractAddress} />
			</div>
		</>
