            ...
            <div className="rounded-[1.25rem] p-4 flex-row justify-center">
              ...
              <Grid container className="mt-8">
                ...
                <Grid
                  ...
                  md={4}
                  lg={4}
                  className="mx-auto flex flex-end justify-end pr-8 pb-4"
                >
                  <ShareButton link={`blogdetails/${blog.title}/${blog.id}`} />
                </Grid>
                <h2
                ...
                <BlogDetails
                  isBlogInfoOpen={openedBlogId === blog.blogId}
                  cryptoSymbol={blog.cryptoSymbol}
                  _blogId={blog.blogId || ''}
                />
              </Grid>
            </div>
