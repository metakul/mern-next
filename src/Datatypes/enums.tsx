...
// define endpoints here
  export const ApiEndpoint: Record<string, any> = {
    ...
    create_bot: { apiId:12, withAuth:true, url: `${base_url_backend}/create_bot`, method: 'POST', headers: { 'Content-Type': 'multipart/form-data',}, loadingMessage:"Loading My Bots",successMessage:"Bots retrievd successfully SuccessFull.", errorMessage:"Oho,Error fetching "},
