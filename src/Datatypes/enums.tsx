...
// define endpoints here
  export const ApiEndpoint: Record<string, any> = {
    ...
    GETBLOG: { apiId:3, withAuth:false, url: `${base_url_backend}/blogs`, method: 'GET', headers: { 'Content-Type': 'application/json'},loadingMessage:"Welcome",successMessage:"SuccessFully Loaded website",errorMessage:""},
    GETSINGLEBLOG: { apiId:4, withAuth:false, url: `${base_url_backend}/blogs/blogType`, method: 'GET', headers: { 'Content-Type': 'application/json'},loadingMessage:"Loading Current Blogs",successMessage:"Blog Loaded SuccessFully",errorMessage:"Error Loading Blog"},
    ...
    create_bot: { apiId:12, withAuth:true, url: `${base_url_backend}/create_bot`, method: 'POST', headers: {  "Content-Type": "multipart/form-data", "boundary":"----WebKitFormBoundaryABC123"}, loadingMessage:"Loading My Bots",successMessage:"Bots retrievd successfully SuccessFull.", errorMessage:"Oho,Error fetching "},
