...
// define endpoints here
  export const ApiEndpoint: Record<string, any> = {
    ...
    GETSINGLEBLOG: { apiId:4, url: 'api/blogs/singleBlog', method: 'GET', headers: { 'Content-Type': 'application/json'},loadingMessage:"Loading Current Blogs",successMessage:"Blog Loaded SuccessFully",errorMessage:"Error Loading Blog"},
