...
const Pricing = () => {
  return (
    <section className="relative pb-12 pt-12 lg:pb-[40px] lg:pt-[60px]">
          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                There are many variations of metakul API's available
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="-mx-4 flex flex-wrap">
            <PricingCard
              ...
              price="$17"
              subscription="year"
              description="Perfect for using for a personal website."
              buttonText="Choose Personal"
            >
              <List>100 Api Calls per sec</List>
              <List>All API except Smart Wallet Trx API </List>
              <List>yearly access</List>
            ...
            <PricingCard
              ...
              price="$77"
              subscription="year"
              description="Perfect for using for a client project."
              buttonText="Choose Professional"
            >
              <List>Unlimited Api Calls per sec</List>
              <List>All API including Smart Wallet Trx API </List>
              <List>Lifetime access</List>
              <List>Free updates</List>
              <List>Unlimited project</List>
              <List>Life Time support</List>
            </PricingCard>
          </div>
        </div>
      </div>
  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2">
        <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke  px-8 py-10 shadow-pricing sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
