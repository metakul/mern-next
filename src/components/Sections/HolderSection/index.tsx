...
export default function HolderBenifits() {
  ...
  return (
    <div className="relative isolate overflow-hidden  py-2 sm:py- lg:overflow-visible lg:px-0">
      ...
      <div className="">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          ...
          />
        <div className="-ml-12 -mt-12 pl-12 pt-12 text-center lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <a href='https://discord.gg/wMcv6HW6VJ' target='_blank'>
            Join discord to get all benefits <LaunchIcon/>
          </a>
        </div>
          <Box sx={{
            display:"flex",
           ...
           <Typography variant="h5" className="item-center mt-2 text-center">
            Total Claimed NFT : {isLoading ? "Loading" : parseInt(totalSupply._hex, 16).toString()}/777
           </Typography>
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-6 lg:px-4">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <h2 className="mt-12 text-2xl font-bold tracking-tight text-gray-900">Not able to claim with your web3 wallet? No problem.</h2>
              <p className="mt-6">
