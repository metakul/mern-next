...
const SocialProfiles: React.FC<SocialProfileProps> = ({ cryptoSymbol }) => {
  ...
  return (
    <div className="mt-2 flex items-center justify-center space-x-2.5">
      ...
      <a href="https://opensea.io/collection/metakul-777" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
        <div
          className="rounded-xl border border-jacarta-100     "
        >
          <div className="js-likes relative inline-flex h-10 w-10 cursor-pointer items-center justify-center text-sm">
          <img src="/Images/opensea-logo.svg" alt="opensea" className="h-8 w-8" />
          </div>
