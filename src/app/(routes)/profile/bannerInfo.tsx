      ...
      <section className="relative bg-light-base pb-12 pt-28 dark:bg-jacarta-800">
        ...
        <div className="container">
          <div className="text-center">
            <h2 className="mb-2 font-display text-4xl font-medium text-jacarta-700 dark:text-white">Shubham Kunwar </h2>
            <div
            ...
            <span className="text-jacarta-400">Joined December 2024</span>
